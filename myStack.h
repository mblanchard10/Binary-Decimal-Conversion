...
public:
    ...
    void reverseStack (stackType<Type> &otherStack);
      //reverseStack to reverse the the order of the stack

    void binToDec (stackType<Type> &binaryStack); 
      //binToDec to convert a binary number to a decimal 
...
void stackType<Type>::reverseStack(stackType<Type> &otherStack){
    ...
    //while loop to reverse the stack
